<div class="container mt5 mb-5 d-flex justify-content-center">
    <div class="card px-1 py-4">
        <div class="card-body">
            ...
            <form action="../../function/regester_student.php" method="POST" id="add_user">
            <div class="row">
                <div class="form-group col-lg-6">
                    ...
                    <div class="form-group col-lg-6">
                        <label for="email"><strong> Series </strong></label>
                            <input type="text" name="series" id="" class="form-control">
                        </div>
                    ...
                    <div class="form-group col-lg-6">
                        <label for="name"><strong> password </strong></label>
                            <input type="text" name="pass" id="" class="form-control" minlength="8">
                        </div>

                    <div class="form-group col-lg-6">
                        <label for="name"><strong> Confirm password </strong></label>
                            <input type="text" name="pass2" id="" class="form-control" minlength="8">
                        </div>
                        <div class="col">
                    </div>
